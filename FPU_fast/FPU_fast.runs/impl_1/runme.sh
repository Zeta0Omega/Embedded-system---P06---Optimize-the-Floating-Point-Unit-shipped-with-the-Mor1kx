...
HD_PWD='/home/luca/Scrivania/ES_Project/FPU_fast/FPU_fast.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pfpu32_top_fast.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pfpu32_top_fast.tcl -notrace
