...
HD_PWD='/home/luca/Scrivania/ES_Project/FPU_fast/FPU_fast.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pfpu32_top_fast.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pfpu32_top_fast.tcl
