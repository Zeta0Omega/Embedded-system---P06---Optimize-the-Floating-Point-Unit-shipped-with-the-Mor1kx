...
\horrule{0.5pt} \\[0.4cm]
\huge \textbf{Optimize the Floating Point Unit shipped with the Mor1kx} \\[.5cm] % The assignment title
\large [ Coding Project ] \\ % Pick one: Monography and Coding Project
\horrule{2pt} \\[0.5cm]
\vfill
\author{}
\begin{tabular}{r l}
\textbf{Student} & Lorenzo Fumagalli \\
\textbf{ID} & 898398 \\[0.5cm]
\textbf{Student} & Luca Guzla \\
\textbf{ID} & 898601 \\[0.5cm]
\textbf{Course} & Embedded System 1 \\
\textbf{Academic Year} & 2018-2019 \\[0.5cm]
\textbf{Advisor} & Davide Zoni \\ %e.g. Simone Libutti, Giuseppe Massari
